...
const AddDepartmentInventoryModal: React.FC<Props> = ({ departmentId }) => {
  ...
  >({
    ...
    onMutate: async (newItem) => {
      const queryKey = ["departments", departmentId, "inventories"];
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({
        queryKey: ["departments", departmentId, "inventories"],
      });
    },
    onError: (error: any) => {
...
export default AddDepartmentInventoryModal;
