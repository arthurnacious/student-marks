...
import DepartmentLecturersTable from "@/components/page-components/departments/slug/lecturers/department-lecturers-table";
...
const page: FC<Props> = ({ params: { slug } }) => {
  return (
    <PageContainerWrapper
      title={`Manage Department Lecturers`}
      trail={
        <Link
          href="/departments"
    ...
    >
      <DepartmentLecturersTable slug={slug} />
    </PageContainerWrapper>
  );
};
