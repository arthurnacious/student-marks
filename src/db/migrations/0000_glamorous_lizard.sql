...
--> statement-breakpoint
CREATE TABLE `departmentLeadersToDepartments` (
	`id` varchar(255) NOT NULL,
	`departmentId` varchar(255) NOT NULL,
	`departmentLeaderId` varchar(255) NOT NULL,
	CONSTRAINT `departmentLeadersToDepartments_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `lecturersToDepartments` (
	`id` varchar(255) NOT NULL,
	`departmentId` varchar(255) NOT NULL,
	`lecturerId` varchar(255) NOT NULL,
	CONSTRAINT `lecturersToDepartments_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `marks` (
	`id` varchar(255) NOT NULL,
...
CREATE TABLE `users` (
	...
	`image` varchar(255),
	`role` enum('Admin','Department Leader','Lecturer','Finance','Student') NOT NULL DEFAULT 'Student',
...
ALTER TABLE `courses` ADD CONSTRAINT `courses_departmentId_departments_id_fk` FOREIGN KEY (`departmentId`) REFERENCES `departments`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `departmentLeadersToDepartments` ADD CONSTRAINT `departmentLeadersToDepartments_departmentId_departments_id_fk` FOREIGN KEY (`departmentId`) REFERENCES `departments`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `departmentLeadersToDepartments` ADD CONSTRAINT `departmentLeadersToDepartments_departmentLeaderId_users_id_fk` FOREIGN KEY (`departmentLeaderId`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `lecturersToDepartments` ADD CONSTRAINT `lecturersToDepartments_departmentId_departments_id_fk` FOREIGN KEY (`departmentId`) REFERENCES `departments`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `lecturersToDepartments` ADD CONSTRAINT `lecturersToDepartments_lecturerId_users_id_fk` FOREIGN KEY (`lecturerId`) REFERENCES `users`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX `slug_idx` ON `courses` (`slug`);--> statement-breakpoint
CREATE INDEX `slug_idx` ON `departments` (`slug`);--> statement-breakpoint
